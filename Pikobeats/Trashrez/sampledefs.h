...
struct sample_t {
  ...
  char sname[20];        // sample name
	...
	Dam_trashreza1,	// pointer to sample array
	Dam_trashreza1_SIZE,	// size of the sample array
	Dam_trashreza1_SIZE,	//sampleindex. if at end of sample array sound is not playing
	46,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Dam_trashreza1",	// sample name

	Dam_trashreza2,	// pointer to sample array
	Dam_trashreza2_SIZE,	// size of the sample array
	Dam_trashreza2_SIZE,	//sampleindex. if at end of sample array sound is not playing
	47,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Dam_trashreza2",	// sample name

	Dam_trashrezb1,	// pointer to sample array
	Dam_trashrezb1_SIZE,	// size of the sample array
	Dam_trashrezb1_SIZE,	//sampleindex. if at end of sample array sound is not playing
	48,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Dam_trashrezb1",	// sample name

	Dam_trashrezb2,	// pointer to sample array
	Dam_trashrezb2_SIZE,	// size of the sample array
	Dam_trashrezb2_SIZE,	//sampleindex. if at end of sample array sound is not playing
	49,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Dam_trashrezb2",	// sample name

	Dam_trashrezc1,	// pointer to sample array
	Dam_trashrezc1_SIZE,	// size of the sample array
	Dam_trashrezc1_SIZE,	//sampleindex. if at end of sample array sound is not playing
	50,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Dam_trashrezc1",	// sample name

	Dam_trashrezc2,	// pointer to sample array
	Dam_trashrezc2_SIZE,	// size of the sample array
	Dam_trashrezc2_SIZE,	//sampleindex. if at end of sample array sound is not playing
	51,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Dam_trashrezc2",	// sample name

	Dam_trashrezc3,	// pointer to sample array
	Dam_trashrezc3_SIZE,	// size of the sample array
	Dam_trashrezc3_SIZE,	//sampleindex. if at end of sample array sound is not playing
	52,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Dam_trashrezc3",	// sample name

	Dam_trashrezd1,	// pointer to sample array
	Dam_trashrezd1_SIZE,	// size of the sample array
	Dam_trashrezd1_SIZE,	//sampleindex. if at end of sample array sound is not playing
	53,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Dam_trashrezd1",	// sample name

	Dam_trashrezd2,	// pointer to sample array
	Dam_trashrezd2_SIZE,	// size of the sample array
	Dam_trashrezd2_SIZE,	//sampleindex. if at end of sample array sound is not playing
	54,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Dam_trashrezd2",	// sample name

	Dam_trashreze1,	// pointer to sample array
	Dam_trashreze1_SIZE,	// size of the sample array
	Dam_trashreze1_SIZE,	//sampleindex. if at end of sample array sound is not playing
	55,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Dam_trashreze1",	// sample name

	Dam_trashreze2,	// pointer to sample array
	Dam_trashreze2_SIZE,	// size of the sample array
	Dam_trashreze2_SIZE,	//sampleindex. if at end of sample array sound is not playing
	56,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Dam_trashreze2",	// sample name

	Dam_trashrezf1,	// pointer to sample array
	Dam_trashrezf1_SIZE,	// size of the sample array
	Dam_trashrezf1_SIZE,	//sampleindex. if at end of sample array sound is not playing
	57,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Dam_trashrezf1",	// sample name

	Dam_trashrezf2,	// pointer to sample array
	Dam_trashrezf2_SIZE,	// size of the sample array
	Dam_trashrezf2_SIZE,	//sampleindex. if at end of sample array sound is not playing
	58,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Dam_trashrezf2",	// sample name

	Dam_trashrezg1,	// pointer to sample array
	Dam_trashrezg1_SIZE,	// size of the sample array
	Dam_trashrezg1_SIZE,	//sampleindex. if at end of sample array sound is not playing
	59,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Dam_trashrezg1",	// sample name

	Dam_trashrezg2,	// pointer to sample array
	Dam_trashrezg2_SIZE,	// size of the sample array
	Dam_trashrezg2_SIZE,	//sampleindex. if at end of sample array sound is not playing
	60,	// MIDI note on that plays this sample
	127,	// play volume 0-127
	"Dam_trashrezg2",	// sample name
